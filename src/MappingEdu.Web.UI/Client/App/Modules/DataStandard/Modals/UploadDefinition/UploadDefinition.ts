...
// ****************************************************************************
// Module app.modules.data-standard.modal.upload-definition
//

var m = angular.module('app.modules.data-standard.modal.upload-definition', []);
...
m.controller('app.modules.data-standard.modal.upload-definition', [
    '$', '$scope', '$uibModalInstance', 'repositories', 'services', 'Upload', 'standard',
    ($, $scope, $uibModalInstance: angular.ui.bootstrap.IModalServiceInstance, repositories: IRepositories, services: IServices, upload, standard) => {
        ...
        $scope.upload = (xsd) => {
            if (xsd) {
                ...
                var url = `api/Import/${standard.DataStandardId}/Definition`;
                if ($scope.overrideData) url += '?overrideData=true';
