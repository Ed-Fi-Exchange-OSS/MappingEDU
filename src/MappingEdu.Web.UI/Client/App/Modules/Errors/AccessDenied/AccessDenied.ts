...
// ****************************************************************************
// Module app.modules.errors.access-denied
//

var m = angular.module('app.modules.errors.access-denied', []);
...
m.config(['$stateProvider', 'settings', ($stateProvider: ng.ui.IStateProvider, settings: ISystemSettings) => {
    ...
    $stateProvider
        .state('app.errors.access-denied', {
            url: '/access-denied',
            data: {
                roles: []
            },
            views: {
                'content@': {
                    templateUrl: `${settings.moduleBaseUri}/Errors/AccessDenied/AccessDenied.tpl.html`,
                    controller: 'app.errors.access-denied'
                }
            }
        });         
}]);
...
m.controller('app.errors.access-denied', ['$scope', 'security', 'repositories', 'services',
