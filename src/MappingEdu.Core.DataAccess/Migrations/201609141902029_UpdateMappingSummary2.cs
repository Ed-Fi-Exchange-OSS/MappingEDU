...
namespace MappingEdu.Core.DataAccess.Migrations
{
    ...
    public partial class UpdateMappingSummary2 : DbMigration
    {
        ...
        private readonly string _alterGetMappingProjectSummary = DataAccessHelper.GetStoredProcedurePath("GetMappingProjectSummary", "Alter2.sql");
        private readonly string _revertGetMappingProjectSummary = DataAccessHelper.GetStoredProcedurePath("GetMappingProjectSummary", "Alter1.sql");
