...
SELECT SystemItemMap.SourceSystemItemId as SourceSystemItemId,
		...
		SystemItemMap.UpdateBy as UpdateBy,
		SystemItemMap.UpdateDate as UpdateDate,
		SystemItemMap.CreateBy as CreateBy,
		SystemItemMap.CreateDate as CreateDate
