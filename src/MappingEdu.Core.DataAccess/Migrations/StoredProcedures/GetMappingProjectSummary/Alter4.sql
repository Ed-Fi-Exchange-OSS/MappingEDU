...
WITH project as (
	...
	result AS (
        ...
        JOIN project as mp on MappedSystemId = mp.SourceDataStandardMappedSystemId
            WHERE IsActive = 1 AND MappedSystemExtensionId is NULL AND ((@ParentSystemItemId = '00000000-0000-0000-0000-000000000000' AND ParentSystemItemId is NULL) OR (ParentSystemItemId = @ParentSystemItemId)) and [MappedSystemId] = mp.SourceDataStandardMappedSystemId
        UNION all
