...
CREATE PROCEDURE [dbo].[MappingProjectReportSourceEnumerationItemMappings]
...
SET @DynamicPivotQuery4 = N'
	...
	SELECT si.ElementGroup as SourceElementGroup,
		    si.ItemName as SourceItemName,
		    si.SourceCodeValue,
		    si.SourceShortDescription,
		    si.SourceDescription,
		    si.SystemEnumerationItemMapId as SystemEnumerationItemMapId,
		    si.EnumerationMappingStatusTypeId,
		    si.EnumerationMappingStatusReasonTypeId,
		    si.TargetCodeValue,
		    si.TargetShortDescription,
		    si.TargetDescription,
		    tsi.ItemName as TargetItemName,
		    tsi.ElementGroup as TargetElementGroup,
		    si.CreatedBy,
		    si.CreateDate,
		    si.UpdatedBy,
		    si.UpdateDate' + 
...
SET @DynamicPivotQuery5 = N'
		FROM #TEMP si
		LEFT JOIN result tsi on si.TargetSystemItemId = tsi.SystemItemId
		ORDER BY si.ElementGroup, si.ItemName, SourceCodeValue;
		DROP TABLE #TEMP;'
